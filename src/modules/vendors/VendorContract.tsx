...
interface Vendor {
  ...
  email: string;
  phone: string;
  slaStatus: 'Active Compliant' | 'At Risk' | 'No SLA';
  slaConditions: string[];
  contractStart: string;
  contractEnd: string;
  notes?: string;
}

export const VendorContract: React.FC = () => {
  ...
  const [newVendor, setNewVendor] = useState({
    ...
    email: '',
    phone: '',
    slaStatus: 'Active Compliant' as Vendor['slaStatus'],
    slaConditionsText: '',
    contractStart: '',
    contractEnd: '',
    notes: ''
              ...
              <div className="drawer-body">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) => setNewVendor(prev => ({ ...prev, slaStatus: e.target.value as any }))}
                  >
                    <option value="Active Compliant">Active Compliant</option>
                    <option value="At Risk">At Risk</option>
                    <option value="No SLA">No SLA</option>
